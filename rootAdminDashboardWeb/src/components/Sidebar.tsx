...
const NAV_ITEMS: NavItem[] = [
  {
    ...
    label: 'Overview',
    roles: ['MUNICIPAL_ADMIN', 'SUPER_ADMIN', 'DEPARTMENT_OPERATOR'],
  },
  {
    to: '/issues',
    icon: <AlertTriangle size={18} />,
    label: 'Issues',
    roles: ['MUNICIPAL_ADMIN', 'SUPER_ADMIN', 'DEPARTMENT_OPERATOR', 'FIELD_WORKER'],
  },
  {
    to: '/tasks',
    icon: <ClipboardList size={18} />,
    label: 'My Tasks',
    roles: ['FIELD_WORKER', 'MUNICIPAL_ADMIN', 'SUPER_ADMIN', 'DEPARTMENT_OPERATOR'],
  },
  {
    to: '/map',
    icon: <Map size={18} />,
